...
<html>
<head>
    <title>MOODLE4XOOPS Custom Installation</title>
...
<form action='index.php' method='post'>
    <table width="778" align="center" cellpadding="0" cellspacing="0" background="img/bg_table.gif">
        ...
        <tr>
            <td width="150" background="img/bg_moodle.png" align="center"><a href="index.php"><img src="../images/moodle_slogo.png" width="92" height="52" alt=""></a></td>
            <td width="478" background="img/bg_moodle.png">&nbsp;</td>
    ...
    <tr>
        <td width='5%'>&nbsp;</td>
        <td colspan="3"><?php if (!empty($title)) {
    echo '<h4 style="margin-top: 10px; margin-bottom: 5px; padding: 10px;">' . $title . '</h4>';
}
            echo '<div style="padding: 10px;">' . $content . '</div>'; ?></td>
        <td width='5%'>&nbsp;</td>
    </tr>
    <tr>
        <td width='5%'>&nbsp;</td>
...
function b_back($option = null)
            {
                ...
                if (isset($option[0]) && '' != $option[0]) {
                    $content .= "<input type='button' value='" . _INSTALL_L42 . "' onclick=\"location='index.php?op=" . htmlspecialchars($option[0], ENT_QUOTES | ENT_HTML5) . "'\"> ";
                } else {
                    $content .= "<input type='button' value='" . _INSTALL_L42 . "' onclick=\"javascript:history.back();\"> ";
                }

                if (isset($option[1]) && '' != $option[1]) {
                    $content .= "<span style='font-size:85%;'><< " . htmlspecialchars($option[1], ENT_QUOTES | ENT_HTML5) . '</span> ';
                }
