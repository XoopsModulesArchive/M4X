...
// $Id: search.php,v 1.8 2004/05/16 10:26:03 stronk7 Exp $
...
print_header(
    "$site->fullname : $strsearchresults",
    $site->fullname,
    "<a href=\"index.php\">$strcourses</a> -> <a href=\"search.php\">$strsearch</a> -> '$search'",
    '',
    '',
    '',
    $searchform
...
if ($courses = get_courses_search(
    ...
    foreach ($courses as $course) {
        $course->fullname = highlight((string)$search, $course->fullname);

        $course->summary = highlight((string)$search, $course->summary);
