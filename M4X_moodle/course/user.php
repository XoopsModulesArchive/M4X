...
// $Id: user.php,v 1.31.8.1 2004/10/02 15:29:02 moodler Exp $
...
$modes = ['outline', 'complete', 'todaylogs', 'alllogs'];
...
add_to_log($course->id, 'course', 'user report', "user.php?id=$course->id&user=$user->id&mode=$mode", (string)$user->id);
...
if ($course->category) {
    print_header(
        "$course->shortname: $stractivityreport ($mode)",
                            ...
                            switch ($mode) {
                                ...
                                case 'complete':
                                    ...
                                    if (function_exists($user_complete)) {
                                        ...
                                        echo "<H4>$image $mod->modfullname: " . "<A HREF=\"$CFG->wwwroot/mod/$mod->modname/view.php?id=$mod->id\">" . "$instance->name</A></H4>";
