...
// $Id: group.php,v 1.14.4.1 2004/10/09 11:45:48 stronk7 Exp $
...
if ($group) {
    if (isteacheredit($course->id) or VISIBLEGROUPS == $course->groupmode) {
...
} elseif (!$group = get_current_group($course->id, 'full')) {
...
if ($edit) {          // We are editing a group's information
    ...
    require __DIR__ . '/group-edit.html';
