...
// $Id: student.php,v 1.19.2.1 2004/10/09 18:43:32 stronk7 Exp $
...
print_header(
    "$course->shortname: $strassignstudents",
...
/// A form was submitted so process the input
    ...
    } elseif (!empty($frm->remove) and !empty($frm->removeselect) and confirm_sesskey()) {
...
if (!$students = get_course_students(
    $course->id,
