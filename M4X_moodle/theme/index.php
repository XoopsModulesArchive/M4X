...
// $Id: index.php,v 1.15.4.1 2004/08/31 13:36:47 moodler Exp $
...
print_header(
    "$site->shortname: $strthemes",
    $site->fullname,
    "<a href=\"$CFG->wwwroot/admin/index.php\">$stradministration</a> -> " . "<a href=\"$CFG->wwwroot/admin/configure.php\">$strconfiguration</a> -> $strthemes"
);
...
if ($choose) {
    if (set_config('theme', $choose)) {
        ...
        } elseif (file_exists("$choose/README.txt")) {
            print_simple_box_start('center');
