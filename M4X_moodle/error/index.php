...
// $Id: index.php,v 1.7 2003/09/11 13:50:02 moodler Exp $
...
if (isset($text)) {    // form submitted
    ...
    email_to_user($admin, $USER, "Error: $referer -> $requested", (string)$text);
...
print_simple_box("An unusual error occurred (tried to reach a page that doesn't exist).<P align=center>$REDIRECT_URL", 'center', '', (string)$THEME->cellheading);
...
<CENTER>
    ...
    <P>
    <FORM action="<?php echo $CFG->wwwroot ?>/error/index.php" name=form method=post>
