...
// $Id: multiple.php,v 1.9 2004/08/22 14:38:44 gustav_delius Exp $
...
print_header_simple(
    (string)$strcreatemultiple,
    (string)$strcreatemultiple,
    "<a href=\"$CFG->wwwroot/mod/quiz/index.php?id=$course->id\">$strquizzes</a>" . " -> <a href=\"edit.php\">$streditingquiz</a> -> $strcreatemultiple"
);
