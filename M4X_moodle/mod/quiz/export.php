...
// $Id: export.php,v 1.5.2.1 2004/09/29 06:51:35 moodler Exp $
...
print_header_simple(
    (string)$strexportquestions,
    (string)$strexportquestions,
    "<a href=\"$CFG->wwwroot/mod/quiz/index.php?id=$course->id\">$strquizzes</a>" . " -> <a href=\"edit.php\">$streditingquiz</a> -> $strexportquestions"
);
...
echo ':</td><td>';
choose_from_menu($categories, 'category', (string)$category->id, '');
echo '</tr>';
