...
// $Id: format.php,v 1.1 2003/12/12 07:35:54 moodler Exp $
////////////////////////////////////////////////////////////////////
...
{
    public function importpreprocess($category)
    {
    ...
    public function importprocess($filename)
    {
        global $CFG, $QUIZ_FILE_FORMAT, $strimportquestions, $form, $question_category, $category, $course, $THEME, $hostname, $mdapath, $mdbpath;
        ...
        foreach ($records as $qrec) {
            ...
            switch ($qrec[3]) {
                ...
                case 2:  // TRUE FALSE
                    ...
                    $question->feedbacktrue = (('T' == $qrec[8]) ? 'Correct. ' : 'Incorrect. ') . $ref;
                    $question->feedbackfalse = (('F' == $qrec[8]) ? 'Correct. ' : 'Incorrect. ') . $ref;
                    break;
                case 3:
    ...
    public function getquestions($filename, $category, $mdapath = '', $hostname = '')
    {
        if (('allcategories' == $category) or ('' == $category)) {
    ...
    public function getquestioncategories($filename, $mdapath = '', $hostname = '')
    {
        global $CFG, $result;
    ...
    public function query_linux($sql, $mdbpath, $mdapath, $hostname)
    {
        global $result;

        require_once 'odbcsocketserver.class.php';
        ...
        xml_set_elementHandler($xml_parser, 'quiz_xmlstart', 'quiz_xmlend');

        xml_set_character_dataHandler($xml_parser, 'quiz_xmldata');
    ...
    public function connect_win($filename)
    {
        global $CFG, $systemdb;
    ...
    public function err($message, $dsn)
    {
