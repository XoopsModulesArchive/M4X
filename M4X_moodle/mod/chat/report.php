...
// $Id: report.php,v 1.16 2004/08/21 20:20:54 gustav_delius Exp $
...
add_to_log($course->id, 'chat', 'report', "report.php?id=$cm->id", (string)$chat->id, (string)$cm->id);
...
if ($start and $end and !$confirmdelete) {   // Show a full transcript
    ...
    if (!$messages = get_records_select(
        'chat_messages',
        "chatid = $chat->id AND 
                                                              timestamp >= '$start' AND 
