...
// $Id: report.php,v 1.18 2004/08/21 21:19:21 gustav_delius Exp $
...
add_to_log($course->id, 'choice', 'report', "report.php?id=$cm->id", (string)$choice->id);

print_header_simple(
    "$choice->name: $strresponses",
    '',
