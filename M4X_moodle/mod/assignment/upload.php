...
// $Id: upload.php,v 1.14 2004/08/21 20:20:53 gustav_delius Exp $
...
add_to_log($course->id, 'assignment', 'upload', "view.php?a=$assignment->id", (string)$assignment->id, $cm->id);
...
} elseif (is_uploaded_file($newfile['tmp_name']) and $newfile['size'] > 0) {
