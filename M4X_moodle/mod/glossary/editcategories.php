...
// $Id: editcategories.php,v 1.9.2.6 2004/10/01 10:26:11 stronk7 Exp $
...
<td align=left width=50%>
    ...
    if ($confirm) {
        $dupcategory = get_record('glossary_categories', 'lcase(name)', mb_strtolower($name), 'glossaryid', $glossary->id);
    ...
    <div align="center">
        ...
        <FORM name="theform" method="post" action="editcategories.php">
            <table width="40%" class=generalbox cellpadding=5 bgcolor="<?php p($THEME->cellheading) ?>">
                ...
                <tr>
                    <td width=100% colspan=2 bgcolor="<?php p($THEME->cellheading2) ?>">
