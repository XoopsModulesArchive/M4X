...
// $Id: upload.php, v1.0 30th April 2003
        ...
        if ($newfile['size'] > $workshop->maxbytes) {
            ...
            if ($newfile_name) {
                    ...
                    if ($assessments = workshop_get_assessments($submission, 'ALL')) {
                        foreach ($assessments as $assessment) {
                            if ($assessment->timecreated < $timenow) {
                                ...
                                $newassessment = workshop_copy_assessment(
                                    $assessment,
                                    $newsubmission,
                                    true
                                );
                ...
                if (move_uploaded_file($newfile['tmp_name'], "$dir/$newfile_name")) {
                    ...
                    add_to_log($course->id, 'workshop', 'submit', "view.php?id=$cm->id", (string)$workshop->id, (string)$cm->id);
                } else {
