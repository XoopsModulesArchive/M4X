...
// $Id: edit.php,v 1.20.2.1 2004/08/25 05:07:30 moodler Exp $
...
if ($form = data_submitted()) {
    ...
    if ($entry) {
        ...
        add_to_log($course->id, 'journal', 'update entry', "view.php?id=$cm->id", (string)$newentry->id, $cm->id);
    } else {
        ...
        add_to_log($course->id, 'journal', 'add entry', "view.php?id=$cm->id", (string)$newentry->id, $cm->id);
    }
