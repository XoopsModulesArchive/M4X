...
// $Id: view.php,v 1.35 2004/08/21 20:20:56 gustav_delius Exp $
...
print_header_simple(
    (string)$journal->name,
    '',
    "<A HREF=index.php?id=$course->id>$strjournals</A> -> $journal->name",
    '',
    '',
    true,
...
if (isteacher($course->id)) {
    ...
    echo "<p align=right><a href=\"report.php?id=$cm->id\">" . get_string('viewallentries', 'journal', $entrycount) . "</a>$groupname</p>";
} elseif (!$cm->visible) {
...
if ('weeks' == $course->format and $journal->days) {
