...
// $Id: playscorm.php,v 1.11.2.2 2004/09/20 14:33:44 bobopinna Exp $
...
if (('top' == $frameset) || ('' != $scorm->popup)) {
    add_to_log($course->id, 'scorm', 'view', "playscorm.php?id=$cm->id", (string)$scorm->id);
