...
// $Id: details.php,v 1.13 2004/08/22 14:38:45 gustav_delius Exp $
...
if ($form = data_submitted($destination)) {
    ...
    print_header_simple(
        (string)$streditingasurvey,
        '',
        "<a href=\"index.php?id=$course->id\">$strsurveys</a>" . " -> $form->name ($streditingasurvey)"
    );
    ...
    <form name=form method=post action="<?php p($form->destination) ?>">
        <table cellpadding=5 align=center>
            <tr>
                <td align=right nowrap><p><b><?php print_string('name') ?>:</b></p></td>
                <td><p><?php p($form->name) ?></p></a></td>
            </tr>
