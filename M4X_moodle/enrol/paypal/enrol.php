...
// $Id: enrol.php,v 1.6 2004/08/21 17:15:07 moodler Exp $
...
class enrolment_plugin extends enrolment_base
{
    ...
    public function get_access_icons($course)
    {
        ...
        if (abs($cost) < 0.01) {
            ...
            $str .= "<p class=\"coursecost\"><font size=-1>$strcost: " . "<a title=\"$strrequirespayment\" href=\"$CFG->wwwroot/course/view.php?id=$course->id\"></a>";

            $str .= (string)$currency . format_float($cost, 2) . '</a></p>';
        }
